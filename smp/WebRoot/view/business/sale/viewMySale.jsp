...
<div class="container" id="bodyContainer">
	...
	<form action="business/saveMySale.action" method="post" class="form-horizontal" id="editForm">
		...
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<s:textfield name="name" id="productName" readonly="true" onclick="showProduct('productId','productName')" class="form-control"></s:textfield>
					<s:hidden name="sale.productId" id="productId"></s:hidden>
				</div>
				<label class="col-sm-2 control-label">单价</label>
				<div class="col-sm-2">
					<s:textfield name="sale.unitPrice" onblur="calcuTotal()" id="unitPrice"></s:textfield>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">数量</label>
				<div class="col-sm-2">
					<s:textfield name="sale.quantity" onblur="calcuTotal()" id="quantity"></s:textfield>
				</div>
				<label class="col-sm-2 control-label">销售额</label>
				<div class="col-sm-2">
					<s:textfield name="sale.total" id="total" readonly="true"></s:textfield>
				</div>
			</div>
...
function nextAdd(){
	window.location.href = "business/viewMySale.action";
}
...
function calcuTotal() {
	var p = document.getElementById("unitPrice").value;
...
function showProductBack(values){
	if(values!=null && values!="") {
		...
		document.getElementById("productName").value = aRetValue[1];
		document.getElementById("unitPrice").value = aRetValue[2];
	}
}
